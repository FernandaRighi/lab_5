...
<html lang="en">
	...
	<body>
		<!-- Page-level header -->
		<header>
<!-- okSTEP 6: Add an IMG element just before the H1 element below, and point the src attribute to the SVG file called "html-logo.svg" inside the 'images' directory - then have a look at the resulting page in a browser -->

<!-- okSTEP 7: Add an appropriate height and width to the above IMG element - the SVG can be scaled to any size, unlike a bitmap (JPG, PNG, GIF), but keep it square -->
<!-- okSTEP 8: Add an appropriate alt attribute to the IMG element above, describing the image -->
...
<!-- STEP 10: Upload all files for this lab to your Web server in https://myserver.azurewebsites.net/week5/lab5/ (URL example would be on a Microsoft Azure server instance) -->
	<img src="images/html-logo.svg" alt="html logo" width="100" height="100" style="margin-top: 20px;">	
...
<!-- okSTEP 4: Surround the IMG element below with a pair of FIGURE tags -->

<!-- okSTEP 1: Insert an IMG element with the src attribute pointing to the image called "mini-figure" in the 'images' directory -->
<figure><img src="images/mini-figure.png" alt="mini figure" width="200" height="250"></figure>
<!-- okSTEP 2: Add an alt attribute with a short phrase that describes the image -->
<!-- okSTEP 3: Determine the native image dimensions (height and width) using your file system, and add a height and width attribute to the IMG element above with the appropriate values -->
<!-- okSTEP 5: Add a FIGCAPTION element below (but before you close the FIGURE element), and add the caption, "Mini figure by Vanja (Public Domain)" -->
<figcaption caption="Mini figure by Vanja (Public Domain) https://openclipart.org/detail/224315/clip-is-a-brick-minifig-4"></figcaption>
			</aside>
